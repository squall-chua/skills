...
> **Community default.** A company skill that explicitly supersedes `references/error-handling/GUIDE.md` takes precedence.
...
- → See `references/samber-oops/GUIDE.md` for full samber/oops API, builder patterns, and logger integration
- → See `references/observability/GUIDE.md` for structured logging setup, log levels, and request logging middleware
- → See `references/safety/GUIDE.md` for nil interface trap and nil error comparison pitfalls
- → See `references/naming/GUIDE.md` for error naming conventions (ErrNotFound, PathError)
