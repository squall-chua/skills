...
This covers **function parameters**, not method receivers (see `references/structs-interfaces/GUIDE.md` for receiver rules).
...
-> See the `references/structs-interfaces/GUIDE.md` for pointer vs value **receiver** rules.
