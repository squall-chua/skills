...
→ See `references/troubleshooting/GUIDE.md` for detailed GODEBUG usage and interpretation.
...
| **Pyroscope / Parca** | Continuous profiling platforms — aggregate pprof profiles over time, compare across deployments, detect regressions. | Production performance monitoring, historical trend analysis. → See `references/observability/GUIDE.md` for setup. |
