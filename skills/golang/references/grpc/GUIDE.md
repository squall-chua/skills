...
- → See `references/context/GUIDE.md` for deadline and cancellation patterns
- → See `references/error-handling/GUIDE.md` for gRPC error to Go error mapping
- → See `references/observability/GUIDE.md` for gRPC interceptors (logging, tracing, metrics)
- → See `references/testing/GUIDE.md` for gRPC testing with bufconn
