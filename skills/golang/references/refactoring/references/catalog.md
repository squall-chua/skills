...
→ See `references/naming/GUIDE.md` for what to rename identifiers _to_. This entry covers only _how_ to apply the rename safely at scale.
...
→ See `references/design-patterns/GUIDE.md` for converting a long parameter list into an options struct rather than just reordering or trimming it.
...
→ See `references/project-layout/GUIDE.md` for target package layout. See [structural.md](structural.md) for the full type-alias gradual-repair recipe.
...
→ See `references/project-layout/GUIDE.md` for target package layout.
...
→ See `references/code-style/GUIDE.md` for the full early-return style rule this refactor works toward.
...
→ See `references/design-patterns/GUIDE.md` for functional options as the alternative when the struct exists to configure construction rather than to group a plain data clump.
...
→ See `references/design-patterns/GUIDE.md` for the target interface-dispatch pattern.
...
- → See `references/naming/GUIDE.md` for what to rename identifiers _to_.
- → See `references/project-layout/GUIDE.md` for target package/directory layout.
- → See `references/design-patterns/GUIDE.md` for options structs, consumer-side interfaces, and interface-dispatch patterns referenced throughout this catalog.
- → See `references/code-style/GUIDE.md` for the guard-clause/early-return style rule.
