...
- → See `references/performance/GUIDE.md` for general caching strategy and when to use in-memory cache vs Redis vs CDN
- → See `references/observability/GUIDE.md` for Prometheus metrics integration and monitoring
- → See `references/database/GUIDE.md` for database query patterns that pair with cache loaders
