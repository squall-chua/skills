...
> **For the full samber/do API, patterns, and advanced features, see the `references/samber-do/GUIDE.md`.**
...
→ See `references/samber-do/GUIDE.md` for full application setup, package organization, lifecycle management, debugging, testing with clone + override, and complete API reference.
