...
- → See `references/observability/GUIDE.md` for slog fundamentals (levels, context, handler setup, migration)
- → See `references/error-handling/GUIDE.md` for the log-or-return rule
- → See `references/security/GUIDE.md` for PII handling in logs
- → See `references/samber-oops/GUIDE.md` for structured error context with `samber/oops`
