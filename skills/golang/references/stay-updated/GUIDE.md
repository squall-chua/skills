...
5. **Bookmark pkg.go.dev** to discover new libraries — → See `references/pkg-go-dev/GUIDE.md` to query a module's latest versions, docs, and vulnerabilities from the CLI
