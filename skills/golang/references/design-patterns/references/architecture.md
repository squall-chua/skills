...
→ See `references/project-layout/GUIDE.md` for 12-Factor App conventions.
...
→ See `references/project-layout/GUIDE.md` for directory structure and layout patterns.
