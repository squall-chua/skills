...
Create `.golangci.yml` at the root of the project. See the `references/lint/GUIDE.md` for the recommended configuration.
...
See `references/lint/GUIDE.md`, `references/security/GUIDE.md`, `references/testing/GUIDE.md`, `references/dependency-management/GUIDE.md`, `references/modernize/GUIDE.md`s.
