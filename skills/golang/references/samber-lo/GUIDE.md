...
- For reactive/streaming pipelines over infinite event streams, → see `references/samber-ro/GUIDE.md` + `samber/ro` package
...
- → See `references/samber-ro/GUIDE.md` for reactive/streaming pipelines over infinite event streams (`samber/ro` package)
- → See `references/samber-mo/GUIDE.md` for monadic types (Option, Result, Either) that compose with lo transforms
- → See `references/data-structures/GUIDE.md` for choosing the right underlying data structure
- → See `references/performance/GUIDE.md` for profiling methodology before switching to `lom`/`lop`
