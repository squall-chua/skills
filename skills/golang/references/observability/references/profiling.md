...
→ See `references/troubleshooting/GUIDE.md` (pprof.md) for on-demand debugging.
...
→ See `references/troubleshooting/GUIDE.md` pprof.md for the full pprof CLI reference (profile types, capturing, analyzing, commands).
