...
→ See `references/concurrency/GUIDE.md` for detailed channel patterns and when to use worker pools instead.
...
→ See `references/database/GUIDE.md` for detailed batch patterns and connection pool configuration.
