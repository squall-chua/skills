...
> **Community default.** A company skill that explicitly supersedes `references/concurrency/GUIDE.md` takes precedence.
...
- -> See `references/performance/GUIDE.md` for false sharing, cache-line padding, `sync.Pool` hot-path patterns
- -> See `references/context/GUIDE.md` for cancellation propagation and timeout patterns
- -> See `references/safety/GUIDE.md` for concurrent map access and race condition prevention
- -> See `references/troubleshooting/GUIDE.md` for debugging goroutine leaks and deadlocks
- -> See `references/design-patterns/GUIDE.md` for graceful shutdown patterns
