...
Use `testifylint` to catch wrong argument order, assert/require misuse, and more. See `references/lint/GUIDE.md`.

## Cross-References

- → See `references/testing/GUIDE.md` for general test patterns, table-driven tests, and CI
- → See `references/lint/GUIDE.md` for testifylint configuration
