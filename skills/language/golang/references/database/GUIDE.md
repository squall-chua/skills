...
> **Community default.** A company skill that explicitly supersedes `references/database/GUIDE.md` takes precedence.
...
For more injection prevention patterns, see the `references/security/GUIDE.md`.
...
For context patterns in depth, see the `references/context/GUIDE.md`.
...
- → See `references/security/GUIDE.md` for SQL injection prevention patterns
- → See `references/context/GUIDE.md` for context propagation to database operations
- → See `references/error-handling/GUIDE.md` for database error wrapping patterns
- → See `references/testing/GUIDE.md` for database integration test patterns
