...
> **Community default.** A company skill that explicitly supersedes `references/dependency-injection/GUIDE.md` takes precedence.
...
For interface-based design foundations (accept interfaces, return structs), see the `references/structs-interfaces/GUIDE.md`.
...
- → See `references/samber-do/GUIDE.md` for detailed samber/do usage patterns
- → See `references/structs-interfaces/GUIDE.md` for interface design and composition
- → See `references/testing/GUIDE.md` for testing with dependency injection
- → See `references/project-layout/GUIDE.md` for DI initialization placement
