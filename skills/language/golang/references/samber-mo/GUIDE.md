...
- -> See `references/samber-lo/GUIDE.md` for functional collection transforms (Map, Filter, Reduce on slices) that compose with mo types
- -> See `references/error-handling/GUIDE.md` for idiomatic Go error handling patterns
- -> See `references/safety/GUIDE.md` for nil-safety and defensive Go coding
- -> See `references/database/GUIDE.md` for database access patterns
- -> See `references/design-patterns/GUIDE.md` for functional options and other Go patterns
