...
→ See `references/spf13-viper/GUIDE.md` for the viper side of this integration.
...
- → See `references/cli/GUIDE.md` for general CLI architecture — project layout, exit codes, signal handling, I/O patterns
- → See `references/spf13-viper/GUIDE.md` for configuration layering alongside cobra (flag → env → file → default precedence)
