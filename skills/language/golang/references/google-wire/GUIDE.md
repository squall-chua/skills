...
For lifecycle, lazy loading, and a full matrix see `references/dependency-injection/GUIDE.md`.
...
- → See `references/uber-dig/GUIDE.md` for runtime reflection-based DI without lifecycle
- → See `references/uber-fx/GUIDE.md` for runtime DI with lifecycle hooks, modules, and signal-aware Run()
- → See `references/samber-do/GUIDE.md` for generics-based DI without reflection
