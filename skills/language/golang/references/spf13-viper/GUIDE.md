...
→ See `references/spf13-cobra/GUIDE.md` for the cobra side of this integration.
...
- → See `references/cli/GUIDE.md` for general CLI architecture — project layout, exit codes, signal handling, cobra+viper integration
- → See `references/spf13-cobra/GUIDE.md` for the cobra side of this integration (flag definition and binding)
- → See `references/testing/GUIDE.md` for general Go testing patterns
