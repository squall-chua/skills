...
For CI pipeline setup (GitHub Actions with `golangci-lint-action`), see the `references/continuous-integration/GUIDE.md`.
...
- → See `references/continuous-integration/GUIDE.md` for CI pipeline with golangci-lint-action
- → See `references/code-style/GUIDE.md` for style rules that linters enforce
- → See `references/security/GUIDE.md` for SAST tools beyond linting (gosec, govulncheck)
