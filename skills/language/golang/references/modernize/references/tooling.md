...
Upgrade to golangci-lint v2. **Migration**: Run `golangci-lint migrate` to convert v1 config to v2. See the `references/lint/GUIDE.md` for the recommended configuration.
...
See the `references/continuous-integration/GUIDE.md` for ready-to-use GitHub Actions assets for both Claude Code and GitHub Copilot.
